...
az_reservoir_data = get_reservoir_data('az', '2018-01-01', '2023-03-31')
ca_reservoir_data = get_reservoir_data('ca', '2018-01-01', '2023-03-31')
nm_reservoir_data = get_reservoir_data('nm', '2018-01-01', '2023-03-31')
